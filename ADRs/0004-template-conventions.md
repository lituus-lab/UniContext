...
# ADR-0004: UniContext conventions

- Status: Accepted
- Date: 2026-07-15
- Scope: UniContext and the conventions every engine started from it inherits
...
src/UniContext.nim         umbrella
src/UniContext/fibonacci.nim  hello-world (NimContracts)
...
- C symbol prefix: the library's own name in lower case (`unicontext_`, so
...
| `UniContext` | `UniFoo` |
| `unicontext` | `unifoo` |
| `libUniContext` | `libUniFoo` |
| `UniContext.h` | `UniFoo.h` |
| `lituus-unicontext` | `lituus-unifoo` |
